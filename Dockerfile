...
ENV SALOME_PLATFORM=UB18.04
ENV SALOME_URL "http://files.salome-platform.org/Salome/Salome${SALOME_VERSION}/SALOME-${SALOME_VERSION}-${SALOME_PLATFORM}-SRC.tgz"
ENV SALOME_FILE_TAR "SALOME-${SALOME_VERSION}-${SALOME_PLATFORM}-SRC.tgz"
...
COPY hash/$SALOME_FILE_MD5 /opt/
COPY hash/$SALOME_FILE_SHA512 /opt/
